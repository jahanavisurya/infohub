...
export default function Converter(){
  ...
  const convert = async ()=>{
    ...
    try{
      const r = await axios.get('http://localhost:5000/api/convert',{params:{amount,from:'INR',to}});
      setResult(r.data)
  ...
  return (<div>
    <div style={{display:'flex',gap:8,alignItems:'center',marginBottom:12}}>
      ...
      <select value={to} onChange={e=>setTo(e.target.value)}><option>USD</option><option>EUR</option></select>
